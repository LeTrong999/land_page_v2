          ...
          <ul class="sidebar-menu" data-widget="tree">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../charts/morris.html"><i class="fa fa-circle-o"></i> Danh sách </a></li>
                <li><a href="../charts/morris.html"><i class="fa fa-circle-o"></i> Role </a></li>
                <li><a href="../charts/flot.html"><i class="fa fa-circle-o"></i> Permission </a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
